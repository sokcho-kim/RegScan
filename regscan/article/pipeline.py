...
### 기사화 가능 여부 판정
각 기사 후보에 대해 아래를 작성하라:
- **기사화 가능**: 근거 충분, 국내 영향 연결 가능
- **기사화 보류**: 근거는 있으나 해석 불충분 → 이유 명시
- **기사화 불가**: 근거 부족 또는 국내 맥락 연결 불가
...
[
  {
    ...
    "headline_draft": "헤드라인 초안 (25자 이내, 의미 중심)",
